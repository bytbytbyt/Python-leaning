...
#     def __str__(self):
#         str = "ID : [%d] quantity : %s price: %d "  %(self.id,self.quantity,self.price) 
#         return str
...
# apple = product(10,1,"apple")
# beef = product(20,2,"beef")

# inven = inventory([apple,beef])
# sum = inven.sum()
# print(sum)
...
'''
(1) property and setter   link : https://zhuanlan.zhihu.com/p/366156798
(2)
'''